...
package gov.gxgt.transfer.common.aspect;
...
import gov.gxgt.transfer.modules.sys.service.SysRoleDeptService;
...
public class DataFilterAspect {
    ...
    @Pointcut("@annotation(gov.gxgt.transfer.common.annotation.DataFilter)")
